...
> Άνοιγμα αυτής της σελίδας στο [https://csamartzi.github.io/logo-touch-sensor/](https://csamartzi.github.io/logo-touch-sensor/)
...
* αναζήτηση για **https://github.com/csamartzi/logo-touch-sensor** και εισαγωγή
...
* επικολλήστε **https://github.com/csamartzi/logo-touch-sensor** και κάντε κλικ στην εισαγωγή
